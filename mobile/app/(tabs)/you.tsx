/**
 * You Screen (Expo Router)
 *
 * Profile, Memory & Settings - shows what Alfred knows and user preferences.
 * Adapted from src/screens/YouScreen for file-based routing.
 */
...
import { Text, Card, Button } from '../../src/components/common';
import { profileApi, projectsApi, habitsApi } from '../../src/api/services';
...
export default function YouScreen() {
  ...
  const loadData = async () => {
    try {
      ...
      const estimatedFacts = projectCount * 5 + habitCount * 3 + 10;

      setStats({
        people: Math.floor(Math.random() * 15) + 5,
        companies: Math.floor(Math.random() * 5) + 2,
        projects: projectCount,
        preferences: habitCount + 10,
